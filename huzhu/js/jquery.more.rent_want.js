                    	  ...
                    	  if(t.find('.'+key)) {
                    	  	if(key == 'contact_show'){
                    	  		...
                    	  		if(value == 0){
                    	  			...
                    	  			//alert(user_mobile);
															var href="../pages/user_rent.php?w_or_m="+w_or_m+"&contact="+contact+"&house_rent_id="+user_house_rent_id+"&gender="+gender;
                    	  		...
                    	  		if(value == 0){
                    	  			...
                    	  			//alert(user_mobile);
															var href="../pages/user_seek.php?w_or_m="+w_or_m+"&contact="+contact+"&house_rent_id="+user_house_rent_id+"&gender="+gender;
                    	  			var innerhtml="<a style='color:blue;text-decoration:underline;' href='"+href+"'>"+value+"</a>";
															if(t.find('.'+key)) t.find('.'+key).html(innerhtml);
                    	  		}
